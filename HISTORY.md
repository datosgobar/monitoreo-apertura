...
* Reporte de novedades de datasets
* Actualiza versión de pydatajson y django-datajsonar
* Nota: a partir de esta versión comienza a usarse [semver](https://semver.org/) 
